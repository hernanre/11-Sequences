...
def run_test_sum_sequence():
    ...
    # ------------------------------------------------------------------
    # DONE: 2. READ the COMMENTS and CODE rin this function,
...
def run_test_count_positive_sines():
    ...
    # Test 11
    expected = 6
    actual = count_positive_sines([100, 101, 102, 103, 104, 105, 106, 107, 108, 109, 110])
    print()
...
def run_test_sum_first_n():
    ...
    # Test 9:
    expected = 97
    actual = sum_first_n([10, 20, 30, 40, 50, -53, -60, -89], 6)
    print()
    print('Test 9 expected:', expected)
    print('       actual:  ', actual)
    # Test 10:
    expected = 124
    actual = sum_first_n([48, -10, 50, 5, -92, 100, -34, 57, 78, 91, 61], 8)
    print()
    print('Test 10 expected:', expected)
    print('       actual:  ', actual)
